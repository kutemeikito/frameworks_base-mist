...
public class MistThemeController {

    private static final String TAG = "MistThemeController";
    private final ContentResolver mContentResolver;
    private final Handler mBackgroundHandler;

    public MistThemeController(ContentResolver contentResolver, Handler backgroundHandler) {
