...
public class BatteryBarController extends LinearLayout implements 
...
"http://schemas.android.com/apk/res/com.android.systemui";
            mLocationToLookFor = attrs.getAttributeIntValue(ns, 
"viewLocation", 0);
        }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        isVertical = (getLayoutParams().height == 
...
getLayoutParams();
    ...
    public void addBars() {
        ...
        if (mStyle == STYLE_REGULAR) {
            addView(new BatteryBar(mContext, mBatteryCharging, 
mBatteryLevel, isVertical),
                    new 
LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                            LayoutParams.MATCH_PARENT, 1));
        } else if (mStyle == STYLE_SYMMETRIC) {
            BatteryBar bar1 = new BatteryBar(mContext, mBatteryCharging, 
mBatteryLevel, isVertical);
            BatteryBar bar2 = new BatteryBar(mContext, mBatteryCharging, 
mBatteryLevel, isVertical);
...
LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
            ...
            BatteryBar bar = new BatteryBar(mContext, mBatteryCharging, 
mBatteryLevel, isVertical);
            bar.setRotation(180);
            addView(bar, new 
LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
