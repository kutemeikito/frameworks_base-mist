...
=
            "system:" + 
Settings.System.STATUSBAR_BATTERY_BAR_BLEND_COLOR_REVERSE;

    public BatteryBar(Context context) {
        this(context, null);
    }

    public BatteryBar(Context context, boolean isCharging, int 
currentCharge) {
        this(context, null);
    ...
    public BatteryBar(Context context, boolean isCharging, int 
currentCharge, boolean isVertical) {
        this(context, null);
    ...
    protected void onAttachedToWindow() {
        ...
        addView(mBatteryBarLayout, new 
RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));

        mBatteryBar = new View(mContext);
        mBatteryBarLayout.addView(mBatteryBar, new 
...
RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,
            ...
            addView(mChargerLayout, new 
RelativeLayout.LayoutParams(pixels,
                    LayoutParams.MATCH_PARENT));
...
BatteryManager.BATTERY_STATUS_CHARGING;
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        if (mLocation > 0 && shouldAnimateCharging && mBatteryCharging && 
mBatteryLevel < 100) {
            start();
        } else {
            stop();
...
(RelativeLayout.LayoutParams) mBatteryBarLayout
                    .getLayoutParams();
            params.height = w;
...
(RelativeLayout.LayoutParams) mBatteryBarLayout
    ...
    public void start() {
        ...
        if (vertical) {
            TranslateAnimation a = new TranslateAnimation(getX(), getX(), 
getHeight(),
            ...
            TranslateAnimation a = new TranslateAnimation(getWidth(), 
mBatteryBarLayout.getWidth(),
                    getTop(), getTop());
            a.setInterpolator(new AccelerateInterpolator());
            a.setDuration(ANIM_DURATION);
            a.setRepeatCount(Animation.INFINITE);
    ...
    private static int getBlendColorForPercent(int fullColor, int 
emptyColor, boolean reversed,
                                        int percentage) {
        ...
        int newAlpha = (int) (emptyAlpha + 
((fullAlpha-emptyAlpha)*blendFactor));
    ...
    private int getColorForPercent(int percentage) {
        if (mBatteryCharging && mUseChargingColor) {
            ...
            return percentage > BATTERY_LOW_VALUE ? mColor : 
mBatteryLowColor;
        }
    }
