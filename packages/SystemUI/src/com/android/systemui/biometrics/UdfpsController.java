...
public class UdfpsController implements DozeReceiver, Dumpable {
    ...
    public UdfpsController(@NonNull Context context,
        ...
        mDisableSmartPixels = mContext.getResources().getBoolean(com.android.systemui.R.bool.config_disableSmartPixelsOnUDFPS);
        ...
        if (com.android.internal.util.mist.MistUtils.isPackageInstalled(mContext,
